...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_SYM] = LAYOUT(
    ...
    XXXXXXX,  XXXXXXX,  KC_BSLS,  KC_PIPE,  KC_AMPR,  /**/  KC_TILD, KC_RPRN, KC_RCBR, KC_RBRC, KC_UNDS,
                                  MO(_FN),  MO(_NUM), /**/  XXXXXXX, KC_TRNS
  ),
  [_FN] = LAYOUT(
    ...
    KC_MUTE,  KC_VOLD,  XXXXXXX,  KC_VOLU,  XXXXXXX,  /**/  KC_F10,  KC_F1,   KC_F2,   KC_F3,   KC_NO,
  ...
  [_NUM] = LAYOUT(
    ...
    XXXXXXX,  KC_APP,   KC_TAB,   KC_BSPC,  KC_ENT,   /**/  KC_0,    KC_1,    KC_2,    KC_3,    KC_PSLS,
                                  XXXXXXX,  KC_TRNS,  /**/  XXXXXXX, KC_NO
  ),
  [_RES] = LAYOUT(
    KC_TRNS,  QK_BOOT,  XXXXXXX,  XXXXXXX,  XXXXXXX,  /**/  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_NO,
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  /**/  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_NO,
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  /**/  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_NO,
                                  XXXXXXX,  XXXXXXX,  /**/  XXXXXXX, KC_NO 
  ),
};
