...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT(
    KC_ESC,     S(G(KC_SPC)), S(C(KC_TAB)), C(KC_TAB), XXXXXXX,   /**/  XXXXXXX, KC_MPRV, KC_MPLY,    KC_MNXT, KC_CAPS,
    KC_LSFT,    KC_LALT,      KC_LCTL,      KC_LGUI,   G(KC_SPC), /**/  KC_LEFT, KC_DOWN, KC_UP,      KC_RGHT, KC_ENT,
    MO(_RESET), XXXXXXX,      KC_PGUP,      KC_PGDN,   XXXXXXX,   /**/  XXXXXXX, KC_BSPC, A(KC_BSPC), KC_TAB,  KC_DEL,
